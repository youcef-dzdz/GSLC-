              ...
              <tr key={p.id} className="hover:bg-[#F9FBFF] transition-colors">
                ...
                <td className={C.td}>
                  <div className="flex gap-1">
                    ...
                    <button onClick={() => setConfirm(p.id)} className="p-1.5 rounded-lg hover:bg-[#FFF0F0] text-[#8A2020] hover:text-[#5A0000] transition-colors" title={t('common.delete')}><Trash2 size={13} /></button>
                  </div>
                </td>
              </tr>
            )) : (

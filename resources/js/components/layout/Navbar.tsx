...
const ROUTE_LABELS: Record<string, { parent: string; pageKey: string }> = {
  ...
  '/admin/tarifs':            { parent: 'Admin',       pageKey: 'nav.tarifs' },
  '/admin/type-conteneurs':  { parent: 'Admin',       pageKey: 'nav.type_conteneurs' },
  '/admin/banques':               { parent: 'Admin',  pageKey: 'nav.banques' },
  '/admin/conditions-generales':  { parent: 'Admin',  pageKey: 'nav.conditions_generales' },

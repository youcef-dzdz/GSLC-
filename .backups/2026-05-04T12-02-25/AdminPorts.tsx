...
const Modal = ({ title, onClose, children }: { title: string; onClose: () => void; children: React.ReactNode }) => (
  <div className="fixed inset-0 flex items-center justify-center bg-black/40" style={{ zIndex: 9999 }}>
    <div className="bg-white rounded-xl border border-[#C5D8F5] w-full max-w-md mx-4 overflow-y-auto" style={{ maxHeight: '85vh', marginTop: '52px' }}>
...
const ConfirmModal = ({ message, onConfirm, onCancel }: { message: string; onConfirm: () => void; onCancel: () => void }) => (
  <div className="fixed inset-0 flex items-center justify-center bg-black/40" style={{ zIndex: 9999 }}>
    <div className="bg-white rounded-xl border border-[#C5D8F5] w-full max-w-sm mx-4 p-6 space-y-4" style={{ maxHeight: '85vh', marginTop: '52px' }}>

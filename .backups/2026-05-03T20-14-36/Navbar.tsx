  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* ── LEFT: breadcrumb + badges (dashboard) | logo (landing) ── */}
        {user && !isHome ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            {/* Breadcrumb */}
            {breadcrumb && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ fontSize: 11, fontWeight: 500, color: '#88A8D0' }}>
                  {breadcrumb.parent}
                </span>
                <span style={{ color: '#C5D8F5', fontSize: 14, lineHeight: 1 }}>›</span>
                <span style={{ fontSize: 14, fontWeight: 700, color: '#0D2A5E' }}>
                  {t(breadcrumb.pageKey)}
                </span>
              </div>
            )}
            {/* Role badge */}
